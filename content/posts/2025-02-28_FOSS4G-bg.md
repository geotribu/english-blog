...
[qgis.bg](https://qgis.bg/) is an informal organization that brings together the Bulgarian FOSS geo enthusiasts. In the landscape dominated by proprietary software, the QGIS.bg is providing learning materials at begginer and advanced level in Bulgarian language for free to anyone who wants to know more about open source GIS and technologies.
